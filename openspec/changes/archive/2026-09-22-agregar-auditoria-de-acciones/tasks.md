...
- [x] 6.4 Ejecutar `bun run check` y una prueba manual en demo de escritura ordinaria, edición con diff, acción sensible rechazada, filtros por grupo/actor/módulo/acción y navegación web/mobile; corregir cualquier falla antes de dar el cambio por terminado.

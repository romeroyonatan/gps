// Una planilla mínima, compartida por las exportaciones de nómina y auditoría.
// Las entradas ZIP no se comprimen; si pesan demasiado, usar deflate.
// Las fechas entran como texto, sin estilos ni el serial de Excel.
